    ...
    <ul class="navbar-nav ml-auto">
     ...
     <div class="nav-item dropdown">
      <a class="nav-link" data-toggle="dropdown" href="#">
        Nur Janah
<img class="img-circle elevation-2" src="{{ url('public')}}/assets-admin/dist/img/nurjanah.jpg" alt="User Image" style="width: 30px; height: 30px;">
        </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ url('public') }}/assets-admin/dist/img/bg.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ url('public') }}/assets-admin/dist/img/nurjanah.jpg" class="img-circle elevation-2" alt="User Image" style="width: 35px; height: 35px;">
        </div>
        <div class="info">
          <a href="#" class="d-block">Nur Janah</a>
        </div>
      </div>
